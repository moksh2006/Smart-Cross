...
\newcommand{\CourseHeader}{UCS503-Software Engineering}
...
\newcommand{\GroupDetails}{Group: \texttt{2C23} \quad BE Third Year, CSE}
\newcommand{\AdvisorDetails}{Dr.Jhonsy Bansal}
